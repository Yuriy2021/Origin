...
const basketEl = document.querySelector('.basket_view');
const basketCounterEl = document.querySelector('.counter-txt');
...
function renderNewProductInBasket(productId) {
    let productRow = `
        <div class="basketRow">
            ...
            <div>
                <span class="productCount" data-productId="${productId}">1</span> pcs.
            </div>
...
/** Увеличение счетчика корзины, при добавлении товара в корзину */
